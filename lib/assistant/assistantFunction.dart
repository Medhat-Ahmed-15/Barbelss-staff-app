...
Future<void> sendPayments(
    double price, int amount, String description, String category) async {
  String url =
      'https://barbells-eg.co/api/v1/payments/clubs/62fa78e6c5a809025f898f37?lang=${localeLanguage == const Locale('en') ? 'en' : 'ar'}';
